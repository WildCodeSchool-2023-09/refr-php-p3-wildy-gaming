...
const containerPlayGame = document.querySelector('.play-game');
const containerWidth = containerPlayGame.offsetWidth;
...
function game() {
    ...
    //Canvas
    var canvas = document.getElementById('planet-defense'),
    ...
    function start() {
        if(!gameOver) {
            ...
            saveScore(record, canvas.getAttribute("id"));
